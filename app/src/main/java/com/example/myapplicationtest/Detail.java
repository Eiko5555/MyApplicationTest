...
public class Detail extends AppCompatActivity {
    ...
    String orgCity, orgState, orgPostal, address, contact, orgWebsite, orgPhone, orgName,
            orgEmail;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.detail_croll);
        id = getIntent().getExtras().getInt("id");
        Log.i("number: ", id.toString());
        tv_name = (TextView) findViewById(R.id.textView_detail_name);
